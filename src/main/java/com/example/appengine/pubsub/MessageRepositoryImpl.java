...
public class MessageRepositoryImpl implements MessageRepository {
  ...
  private Datastore getDatastoreInstance() {
    ...
    File credentialsPath = new File(JSONFILE);  // TODO: update to your key path.
    ...
    Datastore m = DatastoreOptions.newBuilder().setCredentials(credentials).build().getService();
    return m;
  }
